...
class ApplicationMailerTest < ActionMailer::TestCase
  ...
  test "html emails use Cragmont template" do
    ...
    assert_includes html, "width: 775px"
    ...
    assert_includes html, "vent-five-emperor-boulder-header-dark-mode"
    assert_includes html, "email-header-image-light"
    assert_includes html, "email-header-image-dark"
